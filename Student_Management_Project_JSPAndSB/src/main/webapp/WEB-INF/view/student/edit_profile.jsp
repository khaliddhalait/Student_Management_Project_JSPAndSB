					...
					<div class="card-body">
						<div>
							<form id="myform" onsubmit="return validate()"
								action="/student/updateprofile" modelAttribute="student" method="post">
								<!--**************************************  card body started *************************** -->
								<input type="hidden" readonly name="id" value="${sessionScope.sobj.id}">
								<div class="row">
									<div class="form-group col-md-6">
										<label for=""> DOB</label> <input type="date" name="dob"
											required id="" class="form-control" value="${sessionScope.sobj.dob}">
									</div>
									<div class="form-group col-md-6">
										<label for=""> Name</label> <input type="text" name="name"
											id="" class="form-control" value="${sessionScope.sobj.name}" required>
									</div>
								...
								<div class="row">
									...
									<div class="form-group col-md-6">
										...
										<textarea name="address" id="" cols="" rows="2"
											class="form-control" required>${sessionScope.sobj.address}</textarea>
									</div>
											...
											<div class="card">
												<div class="card-body">
													<form id="cpform" onsubmit="return validatePassword()"
														action="/student/updatepassword" method="post">
														<div class="form-group">
															<label for="">Enter current Password</label> <input
																...
																value="${sessionScope.sobj.email}" name="email"> <br>
